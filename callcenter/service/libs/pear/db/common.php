...
// +----------------------------------------------------------------------+
//
// $Id: common.php,v 1.1 2008/11/14 05:34:49 phuonghong Exp $
 ...
 *
 * @package  DB
 * @version  $Id: common.php,v 1.1 2008/11/14 05:34:49 phuonghong Exp $
 * @category Database
 * @author   Stig Bakken <ssb@php.net>
...
class DB_common extends PEAR
{
    ...
    function &limitQuery($query, $from, $count, $params = array())
    {
        ...
        $result =& $this->querydata($query, $params);

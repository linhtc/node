...
class CI_Pagination {
	...
	function create_links($cur_page=0)
	{
		...
		$output .= '<span class="fright" style="margin-left:20px;">Hiển thị '.$this->from.' <span class="glyphicon glyphicon-arrow-right" aria-hidden="true"></span> '.$this->to.' / '.$this->total_rows.'</span>';
